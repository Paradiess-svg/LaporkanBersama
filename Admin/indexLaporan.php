...
<body>
    ...
    <div class="container">
        ...
        <a href="indexPetugas.php" type="button" class="btn btn-primary mb-3"> <i class="fa fa-users"></i> Cek
            Petugas</a>
        <a href="../logout.php" type="button" class="btn btn-danger mb-3"> <i class="fa fa-user-times"></i> Logout</a>
        <a href="indexLaporanExport.php" type="button" class="btn btn-success mb-3"> <i class="fa fa-file"></i> <i
                class="fa fa-caret-right"></i> Export</a>
        <?php
